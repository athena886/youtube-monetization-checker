...
const required = ['public/index.html','public/favicon.svg','public/monetization-checker/index.html','public/earnings-calculator/index.html','public/youtube-monetization-requirements/index.html','public/youtube-earnings-by-channel-size/index.html','public/assets/site.css','public/assets/site.js','public/robots.txt','public/sitemap.xml','functions/api/check.js','.env.example'];
